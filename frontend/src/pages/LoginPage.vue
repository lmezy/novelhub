  ...
  <div class="min-h-screen bg-paper">
    ...
    <main class="max-w-sm mx-auto px-4 py-16">
      ...
      <form @submit.prevent="submit" class="space-y-4">
        <div>
          <label class="block text-sm text-muted mb-1">Username</label>
          <input
            v-model="username"
            type="text"
            class="w-full px-3 py-2 rounded-lg border border-border bg-surface text-ink placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-accent/30 text-sm"
            placeholder="Username"
          />
        </div>
        <div v-if="isRegister">
          <label class="block text-sm text-muted mb-1">Email (optional)</label>
          <input
            v-model="email"
            type="email"
            class="w-full px-3 py-2 rounded-lg border border-border bg-surface text-ink placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-accent/30 text-sm"
